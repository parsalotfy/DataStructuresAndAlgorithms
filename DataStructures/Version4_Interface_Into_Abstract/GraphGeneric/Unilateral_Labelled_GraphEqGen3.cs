...
namespace DataStructures.Version4_Interface_Into_Abstract.GraphGeneric
{
    public class Unilateral_Labelled_GraphEqGen3<T> : IGraphEqGen3<Unilateral_LabelledEdgeE4<T>, T> where T : IEquatable<T>
    {
        ...
        public Unilateral_Labelled_GraphEqGen3(ISet<T> nodes, ISet<Unilateral_LabelledEdgeE4<T>> edges) : this(nodes)
        {
