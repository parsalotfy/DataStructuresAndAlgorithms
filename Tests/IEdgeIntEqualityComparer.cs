...
namespace Tests
{
    public class IEdgeIntEqualityComparer : EqualityComparer<IEdge<int>>
    {
        ...
        {
            return INodeIntEqualityComparer.Instance.Equals(x.A_Node, y.A_Node) &&
                    INodeIntEqualityComparer.Instance.Equals(x.Another_Node, y.Another_Node);
        }

        public override int GetHashCode(IEdge<int> edge)
        {
            return INodeIntEqualityComparer.Instance.GetHashCode(edge.A_Node)^
                    INodeIntEqualityComparer.Instance.GetHashCode(edge.Another_Node);
        }
    }
}